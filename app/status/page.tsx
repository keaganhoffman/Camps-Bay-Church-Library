// Status page (moved here from / when the kiosk took over the home
// page in Phase 2). Handy for checking the database connection and
// seeing live data at a glance — visit /status any time.
...
export default async function StatusPage() {
  ...
  return (
    <main className="status-page">
      <h1>Library</h1>
      <p className="lede">
        Supabase is connected and the tables are live. This page shows the raw data behind
        the kiosk.
      </p>
